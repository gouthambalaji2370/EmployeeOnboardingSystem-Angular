...
traveller={
  ...
  it("should call patch API to update employee", () => {
    service.save(traveller,1,2).subscribe();
    ...
    expect(req.request.body).toEqual(saveData);
  });
  it("should call patch API to update employee and change status", () => {
    service.register(traveller,1,2).subscribe();
  ...
  it("get basic details", () => {
    ...
    let data=service.getBasicDetails();
  ...
  it("get basic details", () => {
    ...
    let data=service.getAddressDetails();
    expect(data).toEqual(result);
  });
